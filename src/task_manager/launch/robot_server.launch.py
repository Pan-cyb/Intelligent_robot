...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("vision_backend", default_value="bpu_yolopose"),
            DeclareLaunchArgument("enable_bpu_vision", default_value="false"),
            DeclareLaunchArgument(
                "bpu_yolo_model_path",
                default_value="/home/sunrise/Myproj/runtime/models/yolo11n_pose_bayese_640x640_nv12.bin",
            ),
            DeclareLaunchArgument("enable_follower_controller", default_value="true"),
            DeclareLaunchArgument("follow_backend", default_value="cmd_vel"),
